...
Public Class res_ecatalogo_vvirtual
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents ddlVendedora As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim nombreVendedora, codigoVendedora As String
        ...
        If Not Page.IsPostBack Then
            ...
            If tUserInfo.perfil.Trim = P_PROMOTORA Then
                ...
                codigoVendedora = tUserInfo.codigoPromo
                nombreVendedora = tUserInfo.nombre

                ddlVendedora.SelectedValue = codigoVendedora
                ddlVendedora.Enabled = False
        ...
        Else
            ...
            codigoVendedora = ddlVendedora.SelectedValue

            If codigoVendedora = "" Then
            ...
            If codigoVendedora = "*" Then
                nombreVendedora = "TODAS LAS VENDEDORAS"
            Else
                ''nombreVendedora = Utiles.get_promotora(tUserInfo.codigoFilial, tUserInfo.codigoSucursal, codigoVendedora)
                nombreVendedora = ddlVendedora.Items(ddlVendedora.SelectedIndex).Text
            End If

            If nombreVendedora = "" Then
                Err.Description = "No se encontró ejec. comercial con codigo: " & codigoVendedora
            ...
            Else
                ...
                Try
                    ...
                    dgResultado.Columns(0).Visible = (codigoVendedora = "*")
                    dgResultado.Columns(1).Visible = (codigoVendedora = "*")

                    Dim dtResult As DataTable

                    dtResult = ventas.resumenEcatalogoCarteraVirtual(codigoVendedora, _
                                                                    fecha_ini, _
                                                                    fecha_fin, _
                                                                    cod_filial, _
                                                                    cod_sucursal)
                    ...
                    lbCodPromo.Text = codigoVendedora
                    lbNomPromo.Text = nombreVendedora
...
#Region " INICIALIZACION DE CONTROLES FORMULARIO "
    Private Sub cargaVendedorasViruales(ByVal codigoSociedad As String)

        Dim wsAndes As cl.gms.andes.ws.OrgSrv = New cl.gms.andes.ws.OrgSrv


        Dim dsVendedorasVirtuales As DataSet = wsAndes.listaVendedorasVirtuales(codigoSociedad)
        With ddlVendedora
            .Visible = True
            .DataSource = dsVendedorasVirtuales.Tables(0)
