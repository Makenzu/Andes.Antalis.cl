...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="analisis_cartera_promotora_x_cliente_clasificacion_antalis.aspx.vb" Inherits="app.ido_sel_analisis_precios_cartera_promotora_x_cliente_clasificacion_antalis" %>
<META content="text/html; charset=iso-8859-1" http-equiv="Content-Type">
<meta name="vs_targetSchema" content="http://schemas.microsoft.com/intellisense/ie5">
<wilson:masterpage id="MPContainer" runat="server">
	<WILSON:CONTENTREGION style="Z-INDEX: 0" id="MPTitle" runat="server">Ventas acumuladas por cliente - clasificación 
Antalis</WILSON:CONTENTREGION>
	<WILSON:CONTENTREGION id="MPCaption" runat="server">Ventas acumuladas por cliente - clasificación 
Antalis</WILSON:CONTENTREGION>
			...
			<TD vAlign="bottom" width="45%" colSpan="2">
				<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="1">
					...
					<TR>
						...
						<TD style="FONT-FAMILY: Arial; COLOR: dimgray; FONT-SIZE: 9px" vAlign="top">
			...
			<TD colSpan="2">
				<asp:DataGrid id="dgResultado" runat="server" Width="100%" CellPadding="3" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="bran1" SortExpression="bran1 DESC" HeaderText="Cod.Cla.Antalis"></asp:BoundColumn>
						<asp:BoundColumn DataField="denominacion" SortExpression="denominacion DESC" HeaderText="Cla. Antalis">
