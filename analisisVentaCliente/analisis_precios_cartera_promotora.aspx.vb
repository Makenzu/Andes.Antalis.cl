...
Public Class analisis_venta_productos_cartera
...
#End Region
    ...
    Private Sub cargaAnalisisPreciosCartera(ByVal codigoFilial As String, _
    ...
    Private Function obtieneAnalisisPreciosCartera(ByVal codigoFilial As String, _
        ...
        Const spName = "ido_sel_analisis_precios_cartera_promotora_x_subfamilia"
...
#End Region
    ...
    Private Sub bConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bConsultar.Click
        ...
        cargaAnalisisPreciosCartera(codigoFilial, codigoSucursal, fechaInicio, fechaTermino, codigoPromotora, codigoArea, codigoFamilia, codigoSubfamilia)
