<%@ Page Language="vb" AutoEventWireup="false" Codebehind="get_familia.aspx.vb" Inherits="app.get_familia"%>
	...
	<HEAD>
		...
		function Validar(){
			...
			if (f.ddlAreas.selectedIndex ==0){
				...
				window.opener.focus();
				window.opener.document.forms[0].txFamilia.value = f.ddlFamilias[f.ddlFamilias.selectedIndex].value
					...
					<TD vAlign="bottom">
						<TABLE id="Table4" cellSpacing="0" cellPadding="0" border="0">
							<TR>
								...
								<TD><IMG alt="" src="../images/tab_familias.gif"></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
					...
					<TD bgColor="whitesmoke" colSpan="2">
						<TABLE id="tbParams" cellSpacing="0" cellPadding="2" width="340" align="center" border="0">
							...
							<TR>
								...
								<TD style="HEIGHT: 22px"><INPUT type="image" value="Elegir" src="../images/aceptar.gif" onclick="javascript: Validar();"></TD>
							</TR>
							<TR>
								<TD height="22"></TD>
