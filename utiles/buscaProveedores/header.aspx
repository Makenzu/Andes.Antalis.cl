<%@ Page Language="vb" AutoEventWireup="false" Codebehind="header.aspx.vb" Inherits="app.header1"%>
						...
						<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="0">
							<TR>
								...
								<TD style="HEIGHT: 20px">
									<asp:TextBox id="tbCodProv" runat="server" MaxLength="10" Width="105px" BorderStyle="Groove"
										CssClass="textBox"></asp:TextBox>
									<asp:Button id="Button1" runat="server" Text="buscar"></asp:Button></TD>
							</TR>
							<TR>
								<TD class="tbl-HorizHeader" style="WIDTH: 7px"></TD>
								<TD class="tbl-HorizHeader"><STRONG> Nombre&nbsp;:</STRONG></TD>
								<TD>
									<asp:TextBox id="tbNomProv" runat="server" MaxLength="50" Width="280px" BorderStyle="Groove"
										CssClass="textBox"></asp:TextBox>
