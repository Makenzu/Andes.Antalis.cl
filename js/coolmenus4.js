...
function hideDDL(action){
			...
			if (document.all) {
				...
				// para optimizar rapidez en paginas con muchos elementos
				// Se limitó a los primeros 110
				for(ix=0; ix <120; ix++) {
					if (count ==120 || ix > 220 ){ break};
					
					objectid = document.all[ix].id;
					objectx = document.all[ix];
					if (objectid.substring(0,3) == 'ddl') {
						if (action=='hide'){
