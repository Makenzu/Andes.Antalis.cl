...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgResultado.DataSource = obtieneDetallePROF(codigoSociedad, codigoMaterial)
        dgResultado.DataBind()


    End Sub

    Private Function obtieneDetallePROF(ByVal codigoSociedad As String, _
                                            ByVal codigoMaterial As String) As DataTable



        Const spName = "ido_sel_acs_proformas_x_material"
    ...
    Private Sub dgResultado_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgResultado.ItemDataBound
        ...
        ElseIf e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            e.Item.Cells(5).Text = String.Format("{0} {1}", CType(e.Item.DataItem("cant_documento"), Double).ToString("#,##0.00"), e.Item.DataItem("um_cant_documento"))
            e.Item.Cells(5).HorizontalAlign = HorizontalAlign.Right
            e.Item.Cells(5).Wrap = False
            e.Item.Cells(7).Text = String.Format("{0} {1}", CType(e.Item.DataItem("cant_documento_umb"), Double).ToString("#,##0"), e.Item.DataItem("umb_cant_documento"))
            ...
            e.Item.Cells(10).Wrap = False
            totalCantidadUMB = totalCantidadUMB + e.Item.DataItem("cant_documento_umb")

            If codigoUMB = "" Then
                codigoUMB = e.Item.Cells(8).Text
            End If

        ElseIf e.Item.ItemType = ListItemType.Footer Then
            e.Item.Cells(5).Text = "TOTAL:"
            e.Item.Cells(5).HorizontalAlign = HorizontalAlign.Right
            e.Item.Cells(7).Text = totalCantidadUMB.ToString("#,##0") & " " & codigoUMB
            e.Item.Cells(7).HorizontalAlign = HorizontalAlign.Right
        End If
