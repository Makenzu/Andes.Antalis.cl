<%@ Page Language="vb" AutoEventWireup="false" Codebehind="manMedidasPlanchas.aspx.vb" Inherits="app.manMedidaPlancha"%>
...
planchas</WILSON:CONTENTREGION>
		<P>
			...
			<asp:Panel id="pDatosCatastro" runat="server">
				<P>
					<asp:DataGrid style="Z-INDEX: 0" id="dgMedidasPlanchas" runat="server" CellPadding="2" AutoGenerateColumns="False">
						...
						<Columns>
							<asp:BoundColumn DataField="id_tamanho_plancha" HeaderText="ID">
								<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
							</asp:BoundColumn>
							<asp:BoundColumn DataField="dmc_tamanho_plancha" HeaderText="Medida plancha">
