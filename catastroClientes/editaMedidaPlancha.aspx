<%@ Page Language="vb" AutoEventWireup="false" Codebehind="editaMedidaPlancha.aspx.vb" Inherits="app.editaMedidaPlancha"%>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<fieldset><legend>Edita Medida Plancha</legend><BR>
				<TABLE id="Table1" border="0" cellSpacing="1" cellPadding="3">
					<TR>
						<TD class="tbl-HorizHeader">Descripción :</TD>
						<TD>
							<asp:TextBox id="tbDmcMedidaPlancha" runat="server" Width="296px"></asp:TextBox></TD>
					</TR>
				</TABLE>
			</fieldset>
			<P></P>
