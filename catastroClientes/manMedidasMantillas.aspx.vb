...
Public Class manMedidaMantillas
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents dgMedidasMantillas As System.Web.UI.WebControls.DataGrid
...
#End Region
    ...
    Const Cnt_JavaScriptWinOpen As String = "window.open('editaMedidaMantilla.aspx?accion={0}&idMedidaMantilla={1}', 'maq', 'menubar=0,resizable=0,width=407,height=208'); return false;"
    ...
    Private Sub despliegaMedidasMantillas()

        Dim dtMedidasMantillas As DataTable = Me.obtieneMedidasMantillas()

        With dgMedidasMantillas
            .DataSource = dtMedidasMantillas
            .DataBind()
        End With

        lMensaje.Text = String.Format("Total {0} medidas de mantillas encontradas.", dtMedidasMantillas.Rows.Count)

    End Sub

    Public Function obtieneMedidasMantillas() As DataTable
        Dim dbConn As SqlConnection = New SqlConnection(Utiles.obtieneStringDeConexion())

        Dim spCall As SqlCommand = New SqlCommand("cma_sel_medidas_mantillas", dbConn)
    ...
    Public Function eliminaMedidaPlancha(ByVal idMedidaPlancha As Integer) As Boolean
        ...
        Dim spCall As SqlCommand = New SqlCommand("cma_eli_medida_mantilla", dbConn)
    ...
    Private Sub dgMedidasMantillas_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgMedidasMantillas.ItemDataBound
    ...
    Private Sub dgMedidasMantillas_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgMedidasMantillas.DeleteCommand
        Dim idRegistro As Integer = e.Item.Cells(0).Text
        If Me.eliminaMedidaPlancha(idRegistro) Then
            Session("MENSAJE_USUARIO") = "Se ha eliminado la medida de mantilla."
            Response.Redirect("manMedidasMantillas.aspx")
        Else
