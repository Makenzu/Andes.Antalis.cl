...
Public Class vta_fisica_item_12mes
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txCodProv As System.Web.UI.WebControls.TextBox
    Protected WithEvents plProveedor As System.Web.UI.WebControls.Panel
    Protected WithEvents lbCodProv As System.Web.UI.WebControls.Label
    Protected WithEvents lbNomProv As System.Web.UI.WebControls.Label
    Protected WithEvents plSubFam As System.Web.UI.WebControls.Panel
    Protected WithEvents rbCodProv As System.Web.UI.WebControls.RadioButton
...
#End Region
    ...
    Private Sub GeneraTabla()
        ...
        Dim incluyeMesActual, excluyeVtaIqq As Integer
        ...
        'Vemos de dónde sacamos los datos
        If plFamilia.Visible = True Then
            ...
            If xCodSubFamilia = "" Then
                Resultados = ventas.vta_item_12meses_t2(xYear, _
                                                        xMes, _
        ...
        For i = 0 To Resultados.Rows.Count - 1
            If xSubFamiliaActual <> CStr(Resultados.Rows(i).Item("cod_subfamilia")) Then
                ...
                trDatos = Crea_Linea(3, "", "CODIGO", "MATERIAL", codUnidadMedida, xTexto, "PROM.<BR>VENTA", "STOCK", "PEND", "CONSIGN", "N° MESES<BR>STOCK")
                tblResultados.Rows.Add(trDatos)
                totalSubfamilia = 0
    ...
    Private Function Crea_Linea(ByVal Tipo As Integer, _
        ...
        ElseIf Tipo = 3 Or Tipo = 4 Or Tipo = 6 Then
            ...
            'Corresponde al código de material
            tcValores = New TableCell
            tcValores.Wrap = False
    ...
    Private Sub ibExportar_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibExportar.Click
        ...
        End If
        Dim sTableHeader As String = "Análisis Venta Item 12 Meses  -  Período " & xMes & "/" & xAño
        ...
        Exportar.RightHeader = Server.HtmlDecode("&amp;Z&amp;&quot;Arial,Negrita&quot;" & COMPANYNAME & "&amp;Venta Item 12 Meses - " & xMes & "/" & xAño)
