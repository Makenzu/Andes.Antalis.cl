...
Public Class vta_vol_item_6mes
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents cbExcluirVtasIqq As System.Web.UI.WebControls.CheckBox
    Protected WithEvents cbExcluirVtasIqq2 As System.Web.UI.WebControls.CheckBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            cbExcluirVtasIqq.Visible = (tUserInfo.codigoFilial = "BOL")
    ...
    Private Sub GeneraTabla()
        ...
        If plFamilia.Visible = True Then
            ...
            If cbExcluirVtasIqq.Checked Then
                excluyeVentasIqq = 1
            Else
                excluyeVentasIqq = 0
            End If
            ...
            If xCodSubFamilia = "" Then
                Resultados = ventas.vta_volumen_6meses(xYear, xMes, tUserInfo.codigoFilial, Session("ID_SUCURSAL"), xCodFamilia, "", "", "", incluyeMesActual, excluyeVentasIqq)
            Else
                Resultados = ventas.vta_volumen_6meses(xYear, xMes, tUserInfo.codigoFilial, Session("ID_SUCURSAL"), "", xCodSubFamilia, "", "", incluyeMesActual, excluyeVentasIqq)
            End If
        Else
            ...
            If cbExcluirVtasIqq2.Checked Then
                excluyeVentasIqq = 1
            Else
                excluyeVentasIqq = 0
            End If
            ...
            If xYear = 2005 And xMes < 8 Then
                ...
                Exit Sub
            End If
            Resultados = ventas.vta_volumen_6meses(xYear, xMes, tUserInfo.codigoFilial, Session("ID_SUCURSAL"), "", "", "", ddlProveedor.SelectedValue, incluyeMesActual, excluyeVentasIqq)
        End If
            ...
            Try
                ...
                If Session("ID_SUCURSAL") = "*" Then
                    ...
                    If (tUserInfo.codigoFilial = "BOL") Then
                        ...
                        If cbExcluirVtasIqq.Checked = False And cbExcluirVtasIqq2.Checked = False Then
        ...
        For i = 0 To Resultados.Rows.Count - 1
            If xSubFamiliaActual <> CStr(Resultados.Rows(i).Item("cod_subfamilia")) Then
                If i > 0 Then
                    ...
                    If (incluyeMesActual) Then
                        Calculo = (Acum1 + Acum2 + Acum3 + Acum4 + Acum5 + Acum6 + Acum7) / 7
                    Else
                        Calculo = (Acum1 + Acum2 + Acum3 + Acum4 + Acum5 + Acum6) / 6
                    End If


                    trDatos = Crea_Linea(6, "", "", "TOTAL SUBFAMILIA: ", "", xTexto, Calculo, AcumStock, AcumPendiente, AcumConsignacion, IIf(Calculo = 0, 0, (AcumStock + AcumPendiente) / Calculo))
                    tblResultados.Rows.Add(trDatos)
                    Acum1 = 0
                    Acum2 = 0
                    Acum3 = 0
                ...
                trDatos = Crea_Linea(3, "", "CODIGO", "MATERIAL", "UN.VOL", xTexto, "PROM.", "STOCK", "PEND", "CONSIGN", "MESES")
                tblResultados.Rows.Add(trDatos)
                totalSubfamilia = 0
            ...
            xTexto = Resultados.Rows(i).Item(14) & "|" & Resultados.Rows(i).Item(13) & "|" & Resultados.Rows(i).Item(12) & "|" & Resultados.Rows(i).Item(11) & "|" & Resultados.Rows(i).Item(10) & "|" & Resultados.Rows(i).Item(9) & "|" & Resultados.Rows(i).Item(15)
        ...
        If plFamilia.Visible = True Then
            If ddlSubFamilia.SelectedValue = "-100" Then
                If (incluyeMesActual) Then
                    Calculo = (Total1 + Total2 + Total3 + Total4 + Total5 + Total6 + Total7) / 7
                Else
                    Calculo = (Total1 + Total2 + Total3 + Total4 + Total5 + Total6) / 6
                End If
    ...
    Private Sub ibExportar_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibExportar.Click
        ...
        End If
        Dim sTableHeader As String = "Análisis Venta Volumen 06 Meses  -  Período " & xMes & "/" & xAño
        ...
        Exportar.RightHeader = Server.HtmlDecode("&amp;Z&amp;&quot;Arial,Negrita&quot;" & COMPANYNAME & "&amp;Listado de Precios - " & xMes & "/" & xAño)
