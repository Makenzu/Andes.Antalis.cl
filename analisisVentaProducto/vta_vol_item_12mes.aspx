...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="vta_vol_item_12mes.aspx.vb" Inherits="app.vta_vol_item_12mes" %>
...
Venta&nbsp;Volumen&nbsp;12 Meses</WILSON:CONTENTREGION>
	<WILSON:CONTENTREGION id="MPCaption" runat="server">Análisis Venta&nbsp;Volumen 12 Meses<BR>
	...
	<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="95%" align="center">
		...
		<TR>
			<TD colSpan="2" align="right">
				<asp:ImageButton id="ibVolver" title="Exportar a Excel" runat="server" Visible="False" ImageUrl="/images/volver.jpg"
					ToolTip="Exportar a Excel" EnableViewState="False"></asp:ImageButton>&nbsp;
				<asp:ImageButton id="ibExportar" title="Exportar a Excel" runat="server" Visible="False" ImageUrl="/images/exportar.gif"
					ToolTip="Exportar a Excel" EnableViewState="False"></asp:ImageButton>&nbsp; <INPUT title="Imprimir" onclick="javascript:imprimir();return false;" alt="Imprimir" src="/images/imprimir.gif"
					type="image"></TD>
		</TR>
	</TABLE>
	<TABLE id="Table1" border="0" cellSpacing="0" cellPadding="3" align="center">
								...
								<TABLE id="tbParams" border="0" cellSpacing="0" cellPadding="2" width="350" align="center">
										...
										<TD style="WIDTH: 79px" class="tbl-HorizHeader" width="79" colSpan="3" align="center">
											<P>
												<asp:CheckBoxList id="cblSubFamilia" runat="server" CssClass="listBox" Visible="False" AutoPostBack="True"
													BorderStyle="Double" Font-Size="XX-Small" BorderWidth="1px" CellSpacing="0" RepeatColumns="1"
													CellPadding="0" Width="340px"></asp:CheckBoxList></P>
										</TD>
									</TR>
									<TR>
										<TD style="WIDTH: 79px" class="tbl-HorizHeader" width="79">
									...
									<TR>
										<TD class="tbl-HorizHeader" colSpan="3" align="left">
											<asp:CheckBox id="cbIncMesActual" runat="server" CssClass="txt-SoftMessage" Text="Considerar mes actual en cálculo de meses stock."></asp:CheckBox></TD>
									</TR>
									<TR>
										<TD class="tbl-HorizHeader" colSpan="3" align="left">
											<asp:CheckBox id="cbExcluyeVentasIqq" runat="server" CssClass="txt-SoftMessage" Text="Excluir ventas Iquique."></asp:CheckBox></TD>
									</TR>
								</TABLE>
							</TD>
						</TR>
							...
							<TR>
								<TD bgColor="#f5f5f5">
									<TABLE id="Table15" border="0" cellSpacing="0" cellPadding="2" width="350">
										...
										<TR>
											<TD style="HEIGHT: 9px" class="tbl-HorizHeader" width="73">Centro</TD>
											<TD style="HEIGHT: 9px" width="3">:</TD>
											<TD style="HEIGHT: 9px" width="409" colSpan="7">
												<asp:DropDownList id="ddlCentro2" runat="server" CssClass="listBox"></asp:DropDownList></TD>
										</TR>
										<TR>
											<TD width="73">
										...
										<TR>
											<TD height="15" colSpan="9" align="left">
												<asp:CheckBox id="cbIncMesActual2" runat="server" CssClass="txt-SoftMessage" Text="Considerar mes actual en cálculo de meses stock."></asp:CheckBox></TD>
										</TR>
										<TR>
											<TD height="15" colSpan="9" align="left">
												<asp:CheckBox id="cbExcluyeVentasIqq2" runat="server" CssClass="txt-SoftMessage" Text="Excluir ventas Iquique."></asp:CheckBox></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
		...
		<TR>
			<TD colSpan="2" align="center">
				<asp:Label id="lbNombreCentro" runat="server" CssClass="listBox"></asp:Label></TD>
		</TR>
		<TR>
			<TD style="WIDTH: 2px; HEIGHT: 54px" colSpan="2">
				<P>
					<asp:Table id="tblResultados" runat="server" CellSpacing="1" CellPadding="2" Width="800px"></asp:Table></P>
				<P>
