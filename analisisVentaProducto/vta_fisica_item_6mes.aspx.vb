...
Public Class vta_fisica_item_6mes
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents cbExcluyeIQQ As System.Web.UI.WebControls.CheckBox
    Protected WithEvents cbExcluyeIQQ2 As System.Web.UI.WebControls.CheckBox
    Protected WithEvents rb1 As System.Web.UI.WebControls.RadioButtonList
    Protected WithEvents rb2 As System.Web.UI.WebControls.RadioButtonList
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            cbExcluyeIQQ.Visible = (tUserInfo.codigoFilial = "BOL")
            cbExcluyeIQQ2.Visible = (tUserInfo.codigoFilial = "BOL")
            ...
            Else
                If ddlSubFamilia.SelectedValue <> Session("ID_SUBFAMILIA") Then
                    ...
                    If ddlSubFamilia.SelectedValue = "-200" Then
                        ...
                        xDatos = Utiles.buscaSubFamilias(eModo.extendido, tUserInfo.codigoFilial, xCodigoFamilia)
    ...
    Private Sub GeneraTabla()
        ...
        Dim Acum1, Acum2, Acum3, Acum4, Acum5, Acum6, Acum7, AcumStock, AcumPendiente, AcumConsignacion As Double
        Dim Total1, Total2, Total3, Total4, Total5, Total6, Total7, TotalStock, TotalPendiente, TotalConsignacion As Double
        Dim promedioVentaAcumulado As Double
        Dim incluyeMesActual As Integer
        Dim excluyeVtasIqq As Integer
        Dim codUnidadMedida As String
        ...
        If plFamilia.Visible = True Then
            ...
            If cbExcluyeIQQ.Checked Then
                excluyeVtasIqq = 1
            Else
                excluyeVtasIqq = 0
            End If

            If rb1.Items(0).Selected Then
                codUnidadMedida = "UMB"
            Else
                codUnidadMedida = "UMV"
            End If
            ...
            If xCodSubFamilia = "" Then
                Resultados = ventas.vta_item_6meses(xYear, _
                                                    xMes, _
                                                    tUserInfo.codigoFilial, _
                                                    Session("ID_SUCURSAL"), _
                                                    xCodFamilia, _
                                                    "", _
                                                    "", _
                                                    "", _
            ...
            Try
                ...
                If Session("ID_SUCURSAL") = "*" Then
                    ...
                    If (tUserInfo.codigoFilial = "BOL") Then
                        ...
                        If cbExcluyeIQQ.Checked = False And cbExcluyeIQQ2.Checked = False Then
                    ...
                    ElseIf (tUserInfo.codigoFilial = "PCL") Then
                        tblStockMaterial = materiales.obtieneStockMateriales("PCL1", "", Resultados)
                    End If
                ...
                For i = 0 To Resultados.Rows.Count - 1
                    If Trim(Resultados.Rows(i).Item("cod_producto")) = tblStockMaterial.Rows(i).Item("material") Then
                        Resultados.Rows(i).Item("val_stock_contable") = tblStockMaterial.Rows(i).Item("stock_contable")
                        Resultados.Rows(i).Item("val_stock_pendiente") = tblStockMaterial.Rows(i).Item("stock_pendiente")
                        Resultados.Rows(i).Item("val_stock_consignacion") = tblStockMaterial.Rows(i).Item("stock_consignacion")
                        ...
                        If tblStockMaterial2.Rows.Count > 0 Then
                            ...
                            For j = 0 To tblStockMaterial2.Rows.Count - 1
                                If (Trim(Resultados.Rows(i).Item("cod_producto")) = Trim(tblStockMaterial2.Rows(j).Item("material"))) Then
                                    Resultados.Rows(i).Item("val_stock_contable") += tblStockMaterial2.Rows(j).Item("stock_contable")
                                    Resultados.Rows(i).Item("val_stock_pendiente") += tblStockMaterial2.Rows(j).Item("stock_pendiente")
                                    Resultados.Rows(i).Item("val_stock_consignacion") += tblStockMaterial2.Rows(j).Item("stock_consignacion")
                                    Exit For
                                End If
                        ...
                        If rb1.SelectedIndex = 1 Or rb2.SelectedIndex = 1 Then
                            Dim fc As Double = buscaFcUmbUmv(xYear, _
                                                                xMes, _
                                                                tUserInfo.codigoFilial, _
                                                                Resultados.Rows(i).Item("cod_producto"))

                            Resultados.Rows(i).Item("val_stock_contable") = Resultados.Rows(i).Item("val_stock_contable") * fc
                            Resultados.Rows(i).Item("val_stock_pendiente") = Resultados.Rows(i).Item("val_stock_pendiente") * fc
                            Resultados.Rows(i).Item("val_stock_consignacion") = Resultados.Rows(i).Item("val_stock_consignacion") * fc
                        End If
                    End If
                Next
        ...
        For i = 0 To Resultados.Rows.Count - 1
            If xSubFamiliaActual <> CStr(Resultados.Rows(i).Item("cod_subfamilia")) Then
                If i > 0 Then
                    'Coloco los totales
                    xTexto = CStr(Acum1) & "|" & CStr(Acum2) & "|" & CStr(Acum3) & "|" & CStr(Acum4) & "|" & CStr(Acum5) & "|" & CStr(Acum6) & "|" & CStr(Acum7)

                    If (incluyeMesActual) Then
                        promedioVentaAcumulado = (Acum1 + Acum2 + Acum3 + Acum4 + Acum5 + Acum6 + Acum7) / 7
                    Else
                        promedioVentaAcumulado = (Acum1 + Acum2 + Acum3 + Acum4 + Acum5 + Acum6) / 6
                    End If


                    trDatos = Crea_Linea(6, "", "", "TOTAL SUBFAMILIA: ", "", xTexto, promedioVentaAcumulado, AcumStock, AcumPendiente, AcumConsignacion, IIf(promedioVentaAcumulado = 0, 0, (AcumStock + AcumPendiente) / promedioVentaAcumulado))
                    tblResultados.Rows.Add(trDatos)
                    Acum1 = 0
                    Acum2 = 0
                    Acum3 = 0
                ...
                ElseIf i = 0 Then
                    ...
                    Else
                        trDatos = Crea_Linea(1, "", Resultados.Rows(i).Item("cod_proveedor") & " - " & UCase(Resultados.Rows(i).Item("nom_proveedor")), "", "", "", "", "", "", "", "")
                    End If
                    tblResultados.Rows.Add(trDatos)
                End If
                'Coloco encabezado
                ...
                tblResultados.Rows.Add(trDatos)
                xTexto = Utiles.ObtieneListaMeses(xMes, xYear, 7)
                trDatos = Crea_Linea(3, "", "CODIGO", "MATERIAL", codUnidadMedida, xTexto, "PROM.", "STOCK", "PEND", "CONSIGN", "N° MESES<BR>STOCK")
                tblResultados.Rows.Add(trDatos)
                totalSubfamilia = 0
                xSubFamiliaActual = Resultados.Rows(i).Item(4)
            End If
            'Coloco la linea de datos
            totalSubfamilia = totalSubfamilia + 1
            acumSubfamilia = acumSubfamilia + 1

            xTexto = Resultados.Rows(i).Item("mes_seis") & "|" & Resultados.Rows(i).Item("mes_cinco") & "|" & Resultados.Rows(i).Item("mes_cuatro") & "|" & Resultados.Rows(i).Item("mes_tres") & "|" & Resultados.Rows(i).Item("mes_dos") & "|" & Resultados.Rows(i).Item("mes_uno") & "|" & Resultados.Rows(i).Item("mes_actual")

            Acum1 = Acum1 + Double.Parse(Resultados.Rows(i).Item("mes_seis"))
            Acum2 = Acum2 + Double.Parse(Resultados.Rows(i).Item("mes_cinco"))
            Acum3 = Acum3 + Double.Parse(Resultados.Rows(i).Item("mes_cuatro"))
            Acum4 = Acum4 + Double.Parse(Resultados.Rows(i).Item("mes_tres"))
            Acum5 = Acum5 + Double.Parse(Resultados.Rows(i).Item("mes_dos"))
            Acum6 = Acum6 + Double.Parse(Resultados.Rows(i).Item("mes_uno"))
            Acum7 = Acum7 + Double.Parse(Resultados.Rows(i).Item("mes_actual"))
            ...
            Total1 = Total1 + Double.Parse(Resultados.Rows(i).Item("mes_seis"))
            Total2 = Total2 + Double.Parse(Resultados.Rows(i).Item("mes_cinco"))
            Total3 = Total3 + Double.Parse(Resultados.Rows(i).Item("mes_cuatro"))
            Total4 = Total4 + Double.Parse(Resultados.Rows(i).Item("mes_tres"))
            Total5 = Total5 + Double.Parse(Resultados.Rows(i).Item("mes_dos"))
            Total6 = Total6 + Double.Parse(Resultados.Rows(i).Item("mes_uno"))
            Total7 = Total7 + Double.Parse(Resultados.Rows(i).Item("mes_actual"))
            ...
            If (incluyeMesActual) Then
                promedioVentaActual = (Double.Parse(Resultados.Rows(i).Item("mes_seis")) + _
                                        ...
                                        Double.Parse(Resultados.Rows(i).Item("mes_actual"))) / 7.0
            Else
                promedioVentaActual = (Double.Parse(Resultados.Rows(i).Item("mes_seis")) + _
                        Double.Parse(Resultados.Rows(i).Item("mes_cinco")) + _
                        Double.Parse(Resultados.Rows(i).Item("mes_cuatro")) + _
                        Double.Parse(Resultados.Rows(i).Item("mes_tres")) + _
                        Double.Parse(Resultados.Rows(i).Item("mes_dos")) + _
                        Double.Parse(Resultados.Rows(i).Item("mes_uno"))) / 6.0
            End If
            ...
            trDatos = Crea_Linea(4, "", "'" & Resultados.Rows(i).Item("cod_producto"), _
                                                ...
                                                Resultados.Rows(i).Item("cod_umb"), _
                                                xTexto, _
        ...
        trDatos = Crea_Linea(6, "", "", "TOTAL SUBFAMILIA: ", "", xTexto, promedioVentaAcumulado, AcumStock, AcumPendiente, AcumConsignacion, IIf(promedioVentaAcumulado = 0, 0, (AcumStock + AcumPendiente - AcumConsignacion) / promedioVentaAcumulado))
        tblResultados.Rows.Add(trDatos)
        trDatos = Crea_Linea(5, "", " ", " ", " ", " ", " ", " ", " ", " ", " ")
        tblResultados.Rows.Add(trDatos)
        'Coloco los totales generales
        xTexto = CStr(Total1) & "|" & CStr(Total2) & "|" & CStr(Total3) & "|" & CStr(Total4) & "|" & CStr(Total5) & "|" & CStr(Total6) & "|" & CStr(Total7)
        If plFamilia.Visible = True Then
            If ddlSubFamilia.SelectedValue = "-100" Then

                If (incluyeMesActual) Then
                    promedioVentaAcumulado = (Total1 + Total2 + Total3 + Total4 + Total5 + Total6 + Total7) / 7
                Else
                    promedioVentaAcumulado = (Total1 + Total2 + Total3 + Total4 + Total5 + Total6) / 6
                End If

                trDatos = Crea_Linea(6, "", "", "TOTAL FAMILIA: ", "", xTexto, promedioVentaAcumulado, TotalStock, TotalPendiente, TotalConsignacion, IIf(promedioVentaAcumulado = 0, 0, (TotalStock + TotalPendiente - TotalConsignacion) / promedioVentaAcumulado))
            Else
                ...
                trDatos = Crea_Linea(6, "", "", "TOTAL SELECCION: ", "", xTexto, promedioVentaAcumulado, TotalStock, TotalPendiente, TotalConsignacion, IIf(promedioVentaAcumulado = 0, 0, (TotalStock + TotalPendiente - TotalConsignacion) / promedioVentaAcumulado))
            End If
        Else
            If (incluyeMesActual) Then
                promedioVentaAcumulado = (Total1 + Total2 + Total3 + Total4 + Total5 + Total6 + Total7) / 7
            ...
            trDatos = Crea_Linea(6, "", "", "TOTAL PROVEEDOR: ", "", xTexto, promedioVentaAcumulado, TotalStock, TotalPendiente, TotalConsignacion, IIf(promedioVentaAcumulado = 0, 0, (TotalStock + TotalPendiente - TotalConsignacion) / promedioVentaAcumulado))
        End If
        tblResultados.Rows.Add(trDatos)
    ...
    Private Sub ibExportar_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibExportar.Click
        ...
        End If
        Dim sTableHeader As String = "Análisis Venta Item 06 Meses  -  Período " & xMes & "/" & xAño
        ...
        Exportar.RightHeader = Server.HtmlDecode("&amp;Z&amp;&quot;Arial,Negrita&quot;" & COMPANYNAME & "&amp;Venta Item 06 Meses - " & xMes & "/" & xAño)
