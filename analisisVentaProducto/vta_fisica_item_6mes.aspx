...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="vta_fisica_item_6mes.aspx.vb" Inherits="app.vta_fisica_item_6mes" %>
...
Venta&nbsp;Item&nbsp;06 Meses</WILSON:CONTENTREGION>
	<WILSON:CONTENTREGION id="MPCaption" runat="server">Análisis Venta&nbsp;Item&nbsp;06 Meses<BR>
	...
	<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="95%" align="center">
		...
		<TR>
			<TD colSpan="2" align="right">
				<asp:ImageButton id="ibVolver" title="Exportar a Excel" runat="server" ToolTip="Exportar a Excel"
					ImageUrl="/images/volver.jpg" Visible="False" EnableViewState="False"></asp:ImageButton>&nbsp;
				<asp:ImageButton id="ibExportar" title="Exportar a Excel" runat="server" ToolTip="Exportar a Excel"
					ImageUrl="/images/exportar.gif" Visible="False" EnableViewState="False"></asp:ImageButton>&nbsp;
	...
	<TABLE id="Table1" border="0" cellSpacing="0" cellPadding="3" align="center">
						...
						<TR>
							<TD style="WIDTH: 305px" bgColor="whitesmoke" colSpan="2">
								<TABLE id="tbParams" border="0" cellSpacing="0" cellPadding="2" width="350" align="center">
										...
										<TD style="WIDTH: 79px" class="tbl-HorizHeader" width="79" colSpan="3" align="center">
											<P>
												<asp:CheckBoxList id="cblSubFamilia" runat="server" CssClass="listBox" Visible="False" AutoPostBack="True"
													RepeatColumns="1" CellSpacing="0" BorderWidth="1px" Font-Size="XX-Small" BorderStyle="Double"
									...
									<TR>
										<TD class="tbl-HorizHeader" colSpan="3" align="left">
											<asp:CheckBox id="cbExcluyeIQQ" runat="server" CssClass="txt-SoftMessage" Text="Excluir ventas Iquique."></asp:CheckBox></TD>
									</TR>
									<TR>
										<TD class="tbl-HorizHeader" colSpan="3" align="left">
											<TABLE id="Table4" border="0" cellSpacing="0" cellPadding="0" width="100%">
												<TR>
													...
													<TD>
														<asp:RadioButtonList id="rb1" runat="server" CssClass="txt-SoftMessage" CellSpacing="0" BorderWidth="0px"
															CellPadding="0">
							...
							<TR>
								<TD bgColor="#f5f5f5">
									<TABLE id="Table15" border="0" cellSpacing="0" cellPadding="2" width="350">
										...
										<TR>
											<TD height="15" colSpan="9" align="left">
												<asp:CheckBox id="cbExcluyeIQQ2" runat="server" CssClass="txt-SoftMessage" Text="Excluir ventas Iquique."></asp:CheckBox></TD>
										</TR>
										<TR>
											<TD height="15" colSpan="9" align="left">
												<TABLE id="Table3" border="0" cellSpacing="0" cellPadding="0" width="100%">
													<TR>
														<TD class="tbl-HorizHeader" vAlign="top">Expresar valores en:</TD>
														<TD>
															<asp:RadioButtonList id="rb2" runat="server" CssClass="txt-SoftMessage" CellSpacing="0" BorderWidth="0px"
																CellPadding="0">
																<asp:ListItem Value="UMB" Selected="True">Unidad Base</asp:ListItem>
																<asp:ListItem Value="UMV">Unidad de Venta</asp:ListItem>
															</asp:RadioButtonList></TD>
		...
		<TR>
			<TD colSpan="2" align="center">
				<asp:Label id="lbNombreCentro" runat="server" CssClass="txt-SoftMessage" Visible="False"></asp:Label></TD>
		</TR>
		<TR>
			<TD style="WIDTH: 2px; HEIGHT: 54px" colSpan="2">
				...
				<P>
					<asp:Label id="lbNota" runat="server" CssClass="txt-SoftMessage"></asp:Label></P>
			</TD>
		</TR>
	</TABLE>
</wilson:masterpage>
